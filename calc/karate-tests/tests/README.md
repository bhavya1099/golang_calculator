...
- Feature file is at: `calc/karate-tests/tests/country_get.feature`
...
```bash
java -Dkarate.config.dir=karate-tests/config -jar Downloads/karate-1.5.1.jar calc/karate-tests/tests/country_get.feature
```
